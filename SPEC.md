...
- Kopfzeile (schwebt beim Scrollen oben, immer sichtbar): Schmidt-Kranz-Logo, Titel, Datenstand ("Stand: [neuestes Quartal]") in einer Zeile, dazu ein Export-Button und der Gesellschafts-Filter ("Gruppenebene" + je eine der 6 Gesellschaften). Bei Auswahl einer konkreten Gesellschaft wird das Schmidt-Kranz-Logo durch deren Logo ersetzt (HAZEMAG und Hazemag Systems teilen sich dasselbe Logo).
